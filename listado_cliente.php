                              ...
                              <td><a href="javascript:void(0);" onClick="window.location='editar_cliente.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Editar" style='text-decoration:none;color:black;'><?php echo $value["cli_tel"]; ?></a></td>
                                ...
                                <td class="actions">
                                  <div class="text-center">
                                    <a href="javascript:void(0);" onClick="window.location='v_vehiculo.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Vehiculo" class="btn btn-xs btn-outline-danger"><i class="glyphicon glyphicon-heart"></i></a>
