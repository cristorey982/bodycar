                              ...
                              <div class="panel-body"> 
                                ...
                                <div class="">
                                 <div class="form-group has-success">
                                    <label class="control-label hidden-xs col-md-2" for="veh_pla">Cliente</label>
                                    <div class="col-xs-6 col-md-4">
                                      <?php echo $nom_cli;?>
                                    </div>

                                    <label class="control-label hidden-xs col-md-2" for="veh_mar">Nit/CC</label>
                                    <div class="col-xs-6 col-md-4">                                 
                                      <?php echo $nom_ide;?>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-xs-6 col-md-3">
                                 ...
                                 <div class="form-group has-success">
                                  <div class="control-label  col-md-offset-2 col-md-8">
                                    <label for="comment" class="control-label col-md-4">Observaciones Estado del Vehiculo:</label>
