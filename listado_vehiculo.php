...
?>
 ...
 <head>
  ...
  <title>::BodyCar - Listado Vehiculo::</title>
                            ...
                            <tr class="odd gradeX">
                              ...
                              <td class="actions">
                                  <div class="text-center">
                                    <a href="javascript:void(0);" onClick="window.location='v_vehiculo_propietario.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Vehiculo" class="btn btn-xs btn-outline-danger"><i class="glyphicon glyphicon-heart"></i>Cliente</a>
                                    <a href="javascript:void(0);" onClick="eliminar('eliminar_vehiculo.php?id=<?php echo $value["id"];?>')" data-toggle="tooltip" title="Eliminar" class="btn btn-xs btn-outline-warning">Eliminar</a>
