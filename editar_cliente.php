                        ...
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                             Editar de documento<small>  bodycar</small></a>
                            </h4>
                          </div>
                          <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                             ...
                             <div class="form-horizontal">
                              <h2>Actualizar la información del cliente</h2>
                              <br>
                               <div class="form-group has-success">
                                  <label class="control-label hidden-xs col-sm-2 col-md-2" for="cli_nom">Nombre</label>
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="cli_nom" name="cli_nom" value="<?php echo $pro[0]["cli_nom"];?>" data-toggle="tooltip"  title="Escribe el nombre!">
                                  </div>

                                  <label  class="control-label hidden-xs col-sm-2 col-md-2" for="cli_ide">Nit/CC</label>
                                  <div class="col-xs-6 col-sm-3 col-md-3">
                                 
                                    <input type="text" class="form-control input-lg" id="cli_ide" name="cli_ide" value="<?php echo $pro[0]["cli_ide"];?>" data-toggle="tooltip" title="">
                                  </div>
                              </div>
                              <div class="form-group has-warning">
                                  <label class="control-label hidden-xs col-sm-2 col-md-2" for="cli_dir">Direccion</label>
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="cli_dir" name="cli_dir" value="<?php echo $pro[0]["cli_dir"];?>" data-toggle="tooltip"  title="Escribe el nombre!">
                                  </div>

                                  <label  class="control-label hidden-xs col-sm-2 col-md-2" for="cli_ema">Email</label>
                                  <div class="col-xs-6 col-sm-3 col-md-3">
                                 
                                    <input type="text" class="form-control input-lg" id="cli_ema" name="cli_ema" value="<?php echo $pro[0]["cli_ema"];?>" data-toggle="tooltip" title="">
                                  </div>
                              </div>
                              <div class="form-group has-success">
                                  <label class="control-label hidden-xs col-sm-2 col-md-2" for="cli_tel">Teléfono</label>
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="cli_tel" name="cli_tel" value="<?php echo $pro[0]["cli_tel"];?>" data-toggle="tooltip"  title="Escribe el nombre!">
                                  </div>

                                  <label  class="control-label hidden-xs col-sm-2 col-md-2" for="cli_ciu">Ciudad</label>
                                  <div class="col-xs-6 col-sm-3 col-md-3">
                                 
                                    <input type="text" class="form-control input-lg" id="cli_ciu" name="cli_ciu" value="<?php echo $pro[0]["cli_ciu"];?>" data-toggle="tooltip" title="">
                                  </div>
                              </div>
                          ...
                          <div class="form-group has-warning">
                            <div class="text-center">
                             <a href="listado_cliente.php" class="btn btn-outline-success btn-lg" role="button"> Atras</a>
