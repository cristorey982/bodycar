                              ...
                              <td><a href="javascript:void(0);" onClick="window.location='editar_cliente.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Editar" style='text-decoration:none;color:black;'><?php echo $value["cli_fec_ing"]; ?></a></td>
                                ...
                                <td class="actions">
                                  <div class="text-center">
                                    <a href="javascript:void(0);" onClick="window.location='v_vehiculo.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Nuevo Vehiculo" class="btn btn-xs btn-outline-danger"><i class="glyphicon glyphicon-plus"></i></a>
                                    <a href="javascript:void(0);" onClick="window.location='listado_vehiculo_cliente.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Listado Vehiculo" class="btn btn-xs btn-outline-success"><i class="glyphicon glyphicon-th-list"></i></a>
                                    <a href="javascript:void(0);" onClick="eliminar('eliminar_cliente.php?id=<?php echo $value["id"];?>')" data-toggle="tooltip" title="Eliminar" class="btn btn-xs btn-outline-warning"><i class="glyphicon glyphicon-trash"></i></a>
                                  </div>
                                </td>
