                              ...
                              <div class="form-group">
                                <div class="form-group has-success ">
                                    ...
                                    <div class="col-xs-6 col-md-10 row mb-3">
                                      <select id="checkboxes" rows="30" multiple aria-label="multiple select example" name="veh_inv[]" class="custom-select input-lg btn-block col-sm-8 col-md-8" data-toggle="tooltip" title="Seleccione el Inventario!">
