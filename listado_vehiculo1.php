                            ...
                            <tr class="odd gradeX">
                              ...
                              <td class="actions">
                                  <div class="text-center">
                                    <a href="javascript:void(0);" onClick="window.location='v_vehiculo_propietario.php?id=<?php echo $value["veh_cli"];?>';" data-toggle="tooltip" title="Propietario" class="btn btn-xs btn-outline-danger"><i class="glyphicon glyphicon-user"></i> </a>
                                    <a href="javascript:void(0);" onClick="window.location='v_orden.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Orden de Servicio" class="btn btn-xs btn-outline-success"><i class="glyphicon glyphicon-pencil"></i> </a>
                                    <a href="javascript:void(0);" onClick="eliminar('eliminar_vehiculo.php?id=<?php echo $value["id"];?>')" data-toggle="tooltip" title="Eliminar" class="btn btn-xs btn-outline-warning"><i class="glyphicon glyphicon-trash"></i> </a>
                                  </div>
                                </td>
