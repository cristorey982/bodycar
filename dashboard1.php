...
?>
 ...
 <head>
  ...
  <title>::BodyCar - Listado Orden::</title>
               ...
               <table id="datatable" class="table display table-striped table-bordered table-hover" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <tr class="odd gradeX">
                              ...
                              <td><a href="javascript:void(0);" onClick="window.location='editar_orden.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="" style='text-decoration:none;color:black;'><?php echo $value["ord_veh"]; ?></a>
                              </td>
                              ...
                              <td><a href="javascript:void(0);" onClick="window.location='editar_orden.php?id=<?php echo $value["id"];?>';" data-toggle="tooltip" title="Orden Servicio" style='text-decoration:none;color:black;'>
                                   <div class="text-center">                 
                                    ...
                                    if ($value["ord_est"]=='1') {?><span class="badge bg-primary text-dark"> <?php echo " Proceso";} 
                                elseif ($value["ord_est"]=='2') {?><span class="badge bg-success text-dark"> <?php echo " Terminado";} 
                                elseif ($value["ord_est"]=='3') {?><span class="badge bg-danger text-dark"> <?php echo " Garantía";} 
