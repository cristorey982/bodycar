                        ...
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                              Ingreso de Cliente<small>  Bodycar</small></a>
                            </h4>
                          </div>
                              ...
                              <br>
                               <div class="form-group has-success">
                                  ...
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="cli_nom" name="cli_nom" placeholder="Digite Nombre!" data-toggle="tooltip"  title="Escribe el nombre!">
                                  </div>

                                  <label  class="control-label hidden-xs col-sm-2 col-md-2" for="cli_ide">Nit/CC</label>
                                  <div class="col-xs-6 col-sm-4 col-md-4">                                 
                                    <input type="text" class="form-control input-lg" id="cli_ide" name="cli_ide" placeholder="Nit/CC" data-toggle="tooltip" title="">
                                  </div>
                              </div>
                                 <div class="form-group has-warning">
                                  ...
                                  <div class="col-xs-6 col-sm-4 col-md-4">                                 
                                    <input type="text" class="form-control input-lg" id="cli_ema" name="cli_ema" placeholder="Email" data-toggle="tooltip" title="">
                                  </div>
                              </div>
                                 <div class="form-group has-success">
                                  <label class="control-label hidden-xs col-sm-2 col-md-2" for="cli_tel">Telefono</label>
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="cli_tel" name="cli_tel" placeholder="Digite Telefono!" data-toggle="tooltip"  title="Escribe el telefono!">
                                  </div>

                                  <label  class="control-label hidden-xs col-sm-2 col-md-2" for="cli_ciu">Ciudad</label>
                                  <div class="col-xs-6 col-sm-4 col-md-4">                                 
                                    <input type="text" class="form-control input-lg" id="cli_ciu" name="cli_ciu" placeholder="Digite ciudad" data-toggle="tooltip" title="">
                                  </div>
                              </div>
