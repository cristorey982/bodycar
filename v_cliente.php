                              ...
                              <br>
                               <div class="form-group has-success">
                                 ...
                                 <div class="form-group has-success">
                                  ...
                                  <div class="col-xs-6 col-sm-4 col-md-4">
                                    <input type="text" class="form-control input-lg" id="cli_tel" name="cli_tel" placeholder="Digite Telefono!" data-toggle="tooltip"  title="Escribe el teléfono!" required>
                                  </div>
