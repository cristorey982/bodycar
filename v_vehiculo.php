                              ...
                              <br>
                               <div class="form-group has-success">
                                  ...
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="veh_pla" name="veh_pla" placeholder="Digite Placa!" data-toggle="tooltip"  title="Escribe la placa!">
                                  </div>

                                  <label  class="control-label hidden-xs col-sm-2 col-md-2" for="veh_mar">Marca</label>
                                  <div class="col-xs-6 col-sm-4 col-md-4">                                 
                                    <input type="text" class="form-control input-lg" id="veh_mar" name="veh_mar" placeholder="Digite Marca!" data-toggle="tooltip" title="Escribe la marca!">
                                  </div>
                              </div>
                                 <div class="form-group has-warning">
                                  <label class="control-label hidden-xs col-sm-2 col-md-2" for="veh_col">Color</label>
                                  <div class="col-xs-6 col-md-4">
                                    <input type="text" class="form-control input-lg" id="veh_col" name="veh_col" placeholder="Digite Color!" data-toggle="tooltip"  title="Escribe el color!">
                                  </div>
                                ...
                                <div class=""><h2>Inventario del Vehiculo</h2></div>
                            <br>
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-primary btn-lg">
                                      <input type="checkbox" name="veh_rad">Radio
                                    </label>
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-danger btn-lg">
                                      <input type="checkbox" name="veh_llav">Llaves
                                    </label>
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                   <label class="btn btn-outline-success btn-lg">
                                    <input type="checkbox" name="veh_par">Parlantes
                                   </label>
                                  </div>
                              </div>
                            </div>
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                   <label class="btn btn-outline-warning btn-lg">
                                    <input type="checkbox" name="veh_ant">Antena
                                   </label>
                                  </div>
                              </div>
                            </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-primary btn-lg">
                                      <input type="checkbox" name="veh_plac">Placas
                                    </label>
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-danger btn-lg">
                                      <input type="checkbox" name="veh_herr">Herramientas
                                    </label>
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                   <label class="btn btn-outline-success btn-lg">
                                    <input type="checkbox" name="veh_gat">Gato
                                   </label>
                                  </div>
                              </div>
                            </div>
                             ...
                             <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                   <label class="btn btn-outline-warning btn-lg">
                                    <input type="checkbox" name="veh_rep">Repuesto
                                   </label>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-primary btn-lg">
                                      <input type="checkbox" name="veh_gas">Tapa gasolina
                                    </label>
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-danger btn-lg">
                                      <input type="checkbox" name="veh_per">Llave pernos
                                    </label>
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                   <label class="btn btn-outline-success btn-lg">
                                    <input type="checkbox" name="veh_tap">Tapetes
                                   </label>
                                  </div>
                              </div>
                            </div>
                             ...
                             <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                   <label class="btn btn-outline-warning btn-lg">
                                    <input type="checkbox" name="veh_bot">Botiquin
                                   </label>
                                  </div>
                              </div>
                            </div>
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-primary btn-lg">
                                      <input type="checkbox" name="veh_cru">Cruceta
                                    </label>
                              ...
                              <div class="col-xs-12 col-md-3">
                                ...
                                <div class="text-center">
                                  <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-outline-danger btn-lg">
                                      <input type="checkbox" name="veh_otr">Otros:
                                    </label>
                               ...
                               <div class="form-group has-success">
                                <div class="control-label  col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8">
                                  <label for="comment" class="control-label col-md-1">Observaciones:</label>
